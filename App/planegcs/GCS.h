...
public:
    ...
    //slope
    int addConstraintSlope(Point& p1, Point& p2, double* slope, int tagId = 0, bool driving = true);
    int addConstraintSlope(Line& l, double* slope, int tagId = 0, bool driving = true);
