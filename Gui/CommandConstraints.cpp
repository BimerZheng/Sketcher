...
public:
        ...
        : GroupCommand("Sketcher_CompDimensionTools")
    {
        ...
        addCommand("Sketcher_ConstrainSlope");
    ...
    : CmdSketcherConstraint("Sketcher_ConstrainSlope")
{
    ...
    sToolTipText = QT_TR_NOOP(
        "Fixes the slope (dy/dx) of the selected line or of the line through two points");
...
void CreateSketcherCommandsConstraints()
{
    ...
    rcCmdMgr.addCommand(new CmdSketcherConstrainSlope());
